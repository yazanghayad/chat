...
export default function ReportFirstResponse() {
  return (
    <ReportShell
      title='First Response Time'
      description='How quickly your team responds to new conversations'
    >
      {({ metrics }) => {
        const { firstResponse, firstResponseByChannel } = metrics;
        const channels = Object.entries(firstResponseByChannel).sort(
          (a, b) => a[1] - b[1]
        );
          ...
          <div className='space-y-6'>
            ...
            <div className='grid grid-cols-3 gap-3'>
              ...
              <KPI
                ...
                value={fmtMin(firstResponse.p90)}
                sub='Slowest 10% above this'
                icon={TrendingUp}
              />
            </div>

            {/* Distribution */}
            {firstResponse.distribution.length > 0 && (
              <div>
                ...
                <Card>
                  <CardContent className='space-y-2 p-4'>
                    {firstResponse.distribution.map((b) => (
              ...
              <div>
                ...
                <Card>
                  <Table>
                    ...
                    <TableBody>
                      {channels.map(([ch, avg]) => {
                        const diff = avg - firstResponse.avg;
                        return (
                          <TableRow key={ch}>
